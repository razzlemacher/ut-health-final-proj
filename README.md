...
The graph is created in the jupyter file `01-create-hetero-network-graph.ipynb`.
...
* [pickle graph](pickle/max_20000_nodes_graph.gpickle) : a binary of networkx graph loaded by the R-GCN in `02-rgcn-model.ipynb`
* [pickled similarity dataframe](pickle/max_20000_nodes_similarity.gpickle) : a binary of patient similarity dataframe loaded by the R-GCN in `02-rgcn-model.ipynb`
